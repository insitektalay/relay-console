...
- Account/Subaccount with Account SID
- Message resource with From, To, Body, Status, ErrorCode, MessagingServiceSid, MediaUrl
- Call resource with TwiML/status callbacks
- Conversation, participant, message, webhook
- Messaging Service with sender pool and compliance configuration
- Phone number, short code, WhatsApp sender, and regulatory bundle
