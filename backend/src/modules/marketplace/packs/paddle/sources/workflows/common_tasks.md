...
- Draft only: Create transactions, invoices, or checkout/payment links that can collect money.
- Draft only: Create refunds, credits, or adjustments against billed/completed transactions.
- Draft only: Update, pause, resume, or cancel subscriptions, especially immediate-proration changes.
- Draft only: Create/update products, prices, discounts, or notification/webhook settings.
