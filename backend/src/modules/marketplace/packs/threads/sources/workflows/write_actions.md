...
- The exact endpoint/method to call: POST /{threads-user-id}/threads to create a text/media container, then POST /{threads-user-id}/threads_publish to publish a finished container.
