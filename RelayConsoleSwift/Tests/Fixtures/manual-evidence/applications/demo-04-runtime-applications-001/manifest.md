# Manual Evidence Manifest - Demo 4 Runtime Applications

id: `fix-manual-applications-demo-04-runtime-applications-001`
...
`ToolRequestService.swift`, `implementation-evidence-packet-matrix.md`

files:

- `manual-evidence/applications/demo-04-runtime-applications-001/manifest.md`
...
surface: `Primary Demo 4 retained runtime and Applications review`

stateKind: `pending`

reasonCode: `manual-demo-04-pending`
...
missingPrerequisites: `Manual reviewer observations for retained runtime dashboard, action-run history, structured jobs, Marketplace catalog, provider connection, Marketplace install, Needed Tools, redaction, unavailable actions, and residual write boundaries remain required.`

currentState: `Automated dependency evidence exists for retained Slice 6/7 services and source-backed UI; Demo 4 manual observations are not yet claimed.`

notParityStatement: `This planned manifest is not completed Demo 4 proof, real OAuth/install proof, command execution proof, file access proof, local app/source-host/generated-pack parity, Paperclip proof, or release readiness.`

activationRequirement: `Reviewer must update status and attach redacted manual observations before this manifest can be cited as completed Demo 4 evidence.`

releaseImpact: `Keeps Demo 4 primary runtime/Applications acceptance evidence explicit while preserving manual residuals.`
...
failureHandling: `If this planned manifest is cited as verified manual proof, ITC-0037 closeout must be downgraded to partial-proof.`
