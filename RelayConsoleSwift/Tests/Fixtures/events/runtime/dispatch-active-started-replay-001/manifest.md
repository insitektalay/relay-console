# Event Replay Fixture Manifest - Active Dispatch Replay

id: `fix-events-runtime-dispatch-active-started-replay-001`
...
- `events/runtime/dispatch-active-started-replay-001/manifest.md`
...
determinism: `The consuming replay test uses stable dispatch, session, message, correlation, event, timestamp, runtime type, and sequence ids; duplicate replay uses the same event id as the dedupe key.`
...
noSimulatedRuntimeOutput: `The fixture records replay state and redacted draft placeholders only; it is not runtime harness output and is not counted as real dispatch proof.`
...
failureHandling: `Any active replay duplicate, ordering, redaction, build, smoke, or diff-hygiene failure blocks ITC-0007 closeout.`

releaseImpact: `This fixture can unblock later event-replay cards only as scaffold proof; it does not prove real-harness, UI, dashboard, AgentOps, report, or release readiness.`
